...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.CategoryTradeTagMapping", b =>
                {
                    b.Property<Guid>("CategoryId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TradeTagId")
                        .HasColumnType("uuid");

                    b.HasKey("CategoryId", "TradeTagId");

                    b.HasIndex("TradeTagId");

                    b.ToTable("CategoryTradeTagMappings", (string)null);
                });
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.GeneratedReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.Invitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.MaintenanceRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.MaintenanceRequestPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.Person", b =>
                {
                    ...
                    b.Property<List<PhoneNumber>>("Phones")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValueSql("'[]'::jsonb");
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.PropertyPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.VendorPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("VendorId", "DisplayOrder")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.VendorTradeTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("VendorTradeTags", (string)null);
                });

            modelBuilder.Entity("PropertyManager.Domain.Entities.VendorTradeTagAssignment", b =>
                {
                    b.Property<Guid>("VendorId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("VendorId", "TradeTagId");

                    b.HasIndex("TradeTagId");

                    b.ToTable("VendorTradeTagAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.WorkOrderTag", b =>
                {
                    ...
                    b.ToTable("WorkOrderTags", (string)null);
                });

            modelBuilder.Entity("PropertyManager.Domain.Entities.WorkOrderTagAssignment", b =>
                {
                    b.Property<Guid>("WorkOrderId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("WorkOrderId", "TagId");

                    b.HasIndex("TagId");

                    b.ToTable("WorkOrderTagAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.Vendor", b =>
                {
                    b.HasBaseType("PropertyManager.Domain.Entities.Person");
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.CategoryTradeTagMapping", b =>
                {
                    b.HasOne("PropertyManager.Domain.Entities.ExpenseCategory", "Category")
                        .WithMany("TradeTagMappings")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PropertyManager.Domain.Entities.VendorTradeTag", "TradeTag")
                        .WithMany("CategoryMappings")
                        .HasForeignKey("TradeTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Category");

                    b.Navigation("TradeTag");
                });
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.ExpenseCategory", b =>
                {
                    b.HasOne("PropertyManager.Domain.Entities.ExpenseCategory", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.MaintenanceRequestPhoto", b =>
                {
                    ...
                    b.HasOne("PropertyManager.Domain.Entities.MaintenanceRequest", "MaintenanceRequest")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.VendorPhoto", b =>
                {
                    ...
                    b.HasOne("PropertyManager.Domain.Entities.Vendor", "Vendor")
                        .WithMany("VendorPhotos")
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.WorkOrderTagAssignment", b =>
                {
                    b.HasOne("PropertyManager.Domain.Entities.WorkOrderTag", "Tag")
            ...
            modelBuilder.Entity("PropertyManager.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("PropertyManager.Domain.Entities.Property", "AssignedProperty")
                        .WithMany()
                        .HasForeignKey("PropertyId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("AssignedProperty");
                });

            modelBuilder.Entity("PropertyManager.Domain.Entities.Vendor", b =>
                {
                    b.HasOne("PropertyManager.Domain.Entities.Person", null)
                        .WithOne()
                        .HasForeignKey("PropertyManager.Domain.Entities.Vendor", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PropertyManager.Domain.Entities.Vendor", b =>
                {
                    b.Navigation("TradeTagAssignments");

                    b.Navigation("VendorPhotos");
