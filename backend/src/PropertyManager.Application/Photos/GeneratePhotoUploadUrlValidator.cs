...
/// <summary>
/// Validator for GeneratePhotoUploadUrlCommand.
/// Uses PhotoValidation constants for consistency.
/// </summary>
public class GeneratePhotoUploadUrlValidator : AbstractValidator<GeneratePhotoUploadUrlCommand>
{
    public GeneratePhotoUploadUrlValidator()
    {
