...
/// <summary>
/// Validator for ConfirmPropertyPhotoUploadCommand.
/// </summary>
public class ConfirmPropertyPhotoUploadValidator : AbstractValidator<ConfirmPropertyPhotoUploadCommand>
{
    public ConfirmPropertyPhotoUploadValidator()
    {
