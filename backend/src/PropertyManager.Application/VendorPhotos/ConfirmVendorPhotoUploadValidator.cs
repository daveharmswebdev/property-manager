...
/// <summary>
/// Validator for ConfirmVendorPhotoUploadCommand.
/// </summary>
public class ConfirmVendorPhotoUploadValidator : AbstractValidator<ConfirmVendorPhotoUploadCommand>
{
    public ConfirmVendorPhotoUploadValidator()
    {
